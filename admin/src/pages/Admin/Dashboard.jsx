  ...
  return dashData && (
    <div className="m-5">
      ...
      <div className="flex flex-wrap gap-3">
        ...
        <div className="flex tems-center gap-2 bg-white p-4 min-w-52  rounded border-2 border-gray-100 cursor-pointer hover:scale-105 transition-all ">
              ...
              <div className="flex items-center px-6 py-3 gap-3 hover:bg-gray-100 border-t " key={index}>
...

                {
                  item.cancelled
                    ...
                    : <img onClick={() => {cancelAppointment(item._id);getDashData() }} className="w-10 cursor-pointer" src={assets.cancel_icon} alt="" />
                }
