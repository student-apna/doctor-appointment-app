...
const About = () => {
  ...
  const features = [
    ...
    {
      title: "Security",
      desc: "Your health data is encrypted and protected with the highest privacy standards.",
    },
    {
      title: "Affordability",
      desc: "Transparent pricing and budget-friendly care for every patient.",
    },
    {
      title: "24/7 Support",
      desc: "Round-the-clock assistance to ensure you're never alone in your healthcare journey.",
    },
  ];
