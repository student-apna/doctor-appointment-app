...
const addDoctor  = async (req,res)=>{
    try {
        ...
        // checking all data before adding
  ...
  const adminLogin = async (req,res)=>{
   ...
   // API to get all appointentment list
...
export {addDoctor,adminLogin,allDoctors,appointmentsAdmin,appointmentCancelAdmin,adminDashboard}